...
/* i32 */
void test_i32_leading_bits(void) {
...
void test_i32_swaping_bits(void) {
...
/* u64 */
void test_u64_leading_bits(void) {
...
void test_u64_swaping_bits(void) {
...
void test_u64_endian(void) {
#if CLIB_BYTE_ORDER == ENDIAN_BIG
  clib_assert(u64_to_le(0x12345678) == 0x78563412,
              "Bytes are somehow different");
  clib_assert(u64_to_be(0x12345678) == 0x12345678,
              "Bytes are somehow different");
#else
...
/* i64 */
void test_i64_leading_bits(void) {
...
void test_i64_swaping_bits(void) {
...
void test_i64_endian(void) {
#if CLIB_BYTE_ORDER == ENDIAN_BIG
  clib_assert(i64_to_le(0x12345678) == 0x78563412,
              "Bytes are somehow different");
  clib_assert(i64_to_be(0x12345678) == 0x12345678,
              "Bytes are somehow different");
#else
